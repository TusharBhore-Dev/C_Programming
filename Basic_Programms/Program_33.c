/*
    ...
    START
        ...
        If number is greater than one:
            Initialize iCnt to 2
            Use a while loop to check divisibility from 2 up to (iNo / 2)
            If iNo is divisible by iCnt, return false immediately
            Increment iCnt in each iteration
            If the loop completes without finding a factor, return true
        Display whether the number is prime based on the boolean result
    STOP
*/
...
//  Description :   It is used to check whether a number is prime using optimized while loop         
//  Input :         Integer
//  Output :        Boolean (bool)
...
bool CheckPrime( int iNo )
{
    ...
    iCnt = 2;                                        // Initialization
    
    while( iCnt <= ( iNo / 2 ) )                     // Optimized loop condition
    {
...
//
//  Input : 13       Output : The number is prime.
//  Input : 22       Output : The number is not prime.
//  Input : 2        Output : The number is prime.
//  Input : -1       Output : Error : Please enter...
//
/////////////////////////////////////////////////////////////////