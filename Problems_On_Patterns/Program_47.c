        ...
        Otherwise, call DisplayPattern:
            ...
            While i is less than or equal to iRow:
                ...
                While j is less than or equal to iCol:
                    Print the value of the current row index (i)
                    Increment j
                After inner loop, print a newline and increment i
    STOP
*/
...
//  Description :   It is used to print a 2D grid pattern using 
//                  nested while loops based on row index.         
